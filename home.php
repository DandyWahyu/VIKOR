<div class="main-panel">
      ...
      <div class="content">
        ...
        <div class="container">
          <h1 class="jumbotron-heading">Welcome <?=  $_SESSION['login'];?></h1>
          <p class="lead text-muted">Aplikasi Sistem Pendukng Keputusan Penilaian Guru Terbaik Pada</p>
          <b>SMA NEGERI 8 MATARAM</b>
          <p>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category">Jumlah Data Alternatif</p>
                  <h3 class="card-title">
                  <?php
                                    $q = $_GET['q'];

                                    $rows = $db->query("SELECT * FROM tb_alternatif 
            ...
            ORDER BY kode_alternatif");
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    Daftar Nama Guru Sebagai Alternatif
                  </div>
                </div>
              </div>
            </div>
...
echo mysqli_num_rows($rows); ?></h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    Kriteria Sebagai Bobot Penilaian Guru
                  </div>
                </div>
              </div>
            </div>
